...
$db="chloechagot"; // le nom de votre base de données.
            // A l'IUT, 3 possibilité prenom_nom prenom_nom1 et prenom_nom2 

$user="chloe.chagot"; // nom d'utilisateur pour se connecter
              // A l'iut prenom.nom	

$passwd="denZSSD"; // mot de passe de l'utilisateur pour se connecter
